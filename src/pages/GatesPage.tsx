...
import { GATES_SUBPAGES } from '../data/pagesContent';

interface GatesPageProps {
  onOpenQuoteModal: (productTitle?: string) => void;
}

export const GatesPage: React.FC<GatesPageProps> = ({ onOpenQuoteModal }) => {
    ...
    <div className="pt-36 pb-24 bg-[#fafaf9]">
      <div className="site-container">
        ...
        <div className="text-[11px] font-mono uppercase tracking-widest text-[#8e9199] mb-8">
          <Link to="/" className="hover:text-[#111215]">Pradžia</Link> / <span>Garažo vartai</span>
        </div>
        ...
        <div className="max-w-3xl space-y-4 mb-16">
          <div className="eyebrow">
            ...
            <span>BUITINIAI IR PRAMONINIAI SEGMENTINIAI VARTAI</span>
          </div>
          <h1 className="text-4xl sm:text-6xl font-light tracking-tight text-[#111215] leading-[1.08]">
            Garažo vartai.{' '}
            <span className="font-serif italic font-normal text-[#c81e1e]">Automatika ir saugumas</span>
          </h1>
          <p className="text-base text-[#64676f] leading-relaxed">
            Šilti 40–45 mm storio poliuretano segmentai, perimetrinės sandarinimo tarpinės bei patikima vokiška Somfy nuotolinio valdymo automatika privatiems garažams ir pramoniniams objektams.
          </p>
        </div>

        {/* Product Cards Grid with Original Photos */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          {GATES_SUBPAGES.map((item, idx) => {
